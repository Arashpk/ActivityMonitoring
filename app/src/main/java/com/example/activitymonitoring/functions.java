...
class functions {
    ...
    private LineGraphSeries<DataPoint> series_FFT_X, series_FFT_Y, series_FFT_Z;
    private double[] realTimeFeature;
    ...
    public void SetVars(int windowLength_, int Fs_,
        ...
        realTimeFeature = realTimeFeature_;
